...
const HeroSection = ({ isMenuShown }) => {
  ...
  return (
    ...
    >
      ...
      <div className="main-desc">Discover How BLC's Blockchain Technology is Revolutionizing Gold and Mineral Resource Trading</div>
      ...
      <div className="flex flex-row justify-center items-center">
        <button className="capitalize main-buttons" title="get BLC" >Get BLC</button>
      </div>
      </div>
</div>
