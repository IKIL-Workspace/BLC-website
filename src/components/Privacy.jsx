...
import { Container, ContentWithPaddingXl } from "../page-components/misc/Layouts";
        ...
        <ContentWithPaddingXl>
          ...
          <Text>
            ...
            <ul>
              ...
              <li>
                <strong>Website</strong> refers to BLC, accessible from https://blc-website.vercel.app/
              </li>{" "}
              <li>
                <strong>Service</strong> refers to the Website.
              </li>
              <li>
                <strong>Country</strong> refers to: Trinidad and Tobago
              </li>
              <li>
                <p>
