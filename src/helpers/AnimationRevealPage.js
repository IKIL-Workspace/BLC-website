...
const StyledDiv = tw.div`bg-black font-display min-h-screen text-secondary-100 p-8 overflow-hidden`;
// const StyledDiv = tw.div`bg-black font-display min-h-screen text-thBlue p-8 overflow-hidden`;
